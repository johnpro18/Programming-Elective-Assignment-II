...
<body>
    ...
    <div class="container-fluid w-100 py-5" style="background-image: linear-gradient(rgba(255, 255, 255, 1), rgba(255, 255, 255,0.5)), url(/resources/images/front-background-3.jpg); background-position: center; background-repeat: no-repeat; background-size: cover;">
        <div class="card mx-auto w-75 p-5 shadow">
            <h1 class="text-center text-uppercase pb-5">course list</h1>
            <table class="table table-hover table-striped">
                ...
                <tbody>
                	<% 
                		...
                		List<Login>list = LoginDao.getCourseList(studentid); 
                    ...
                    <tr>
                        ...
                        <td>${l.getCourseLecturer()}</td>
                        <td>${l.getCourseTimeVenue()}</td>
                    </tr>
                    </c:forEach>
                </tbody>    
            </table>
